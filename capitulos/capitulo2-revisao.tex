\chapter{TRÂNSITO E SEGURANÇA VIÁRIA}
\label{capitulo1}
...
\nomenclature{PPGT}{Programa de Pós-Graduação em Transportes}
\nomenclature{$\epsilon$}{Deformação específica}

PPGT cf. \cite{soares2007ginga}
